...
<div class="actualidad__title">
        <h5>CONTACTO</h5>
        <hr>
        <img src="../img/detalle-small.png" alt="">
    </div>
    <div class="actualidad__subtitle">
        <h2>Últimas novedades fiscales,
            <br>laborales y contables
        </h2>
        <div class="actualidad__points">
            <div>
